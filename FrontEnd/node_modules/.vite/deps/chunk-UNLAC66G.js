...
function useColorProcessor(seriesType) {
  const colorProcessors = React26.useContext(ColorContext);
  if (!seriesType) {
...
function DefaultChartsLegend(props) {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React36.useMemo(() => {
    let x = 0;
    let y = 0;
...
//# sourceMappingURL=chunk-UNLAC66G.js.map
