...
function useCurrentColorScheme(options) {
  ...
  const setMode = React31.useCallback((mode2) => {
...
var SeriesContext = React38.createContext({
  isInitialized: false,
  data: {}
});
if (true) {
...
function SeriesContextProvider(props) {
  ...
  const formattedSeries = React38.useMemo(() => ({
    isInitialized: true,
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React39.useContext(SeriesContext);
  if (!isInitialized) {
...
function usePieSeries() {
  ...
  return React39.useMemo(() => series.pie, [series.pie]);
}
function useLineSeries() {
  const series = useSeries();
  return React39.useMemo(() => series.line, [series.line]);
}
function useBarSeries() {
  const series = useSeries();
  return React39.useMemo(() => series.bar, [series.bar]);
}
function useScatterSeries() {
  const series = useSeries();
  return React39.useMemo(() => series.scatter, [series.scatter]);
}
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React46.useRef({
    x: -1,
    y: -1
  });
  React46.useEffect(() => {
...
var ChartsSurface = React47.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width: width2,
    height: height2,
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7RXLZNFL.js.map
